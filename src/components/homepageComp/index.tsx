    ...
    <div className='w-full h-full flex flex-col gap-5'>
      ...
      <div className='w-full h-full flex lg:flex-row flex-col justify-center items-center gap-3'>
        <aside className="w-full lg:w-2/3 h-full flex justify-center lg:justify-start items-center lg:items-center">
          ...
          <Box className='' sx={{ display: { xl: "none", lg: "none", md: "none", sm: "block", xs: "block" } }}>
        ...
        <aside className="w-full h-full flex gap-3 justify-center lg:justify-start items-center lg:items-start flex-col">
          ...
          <section className='p-3 flex flex-col justify-center items-left gap-3'>
            <p className='text-wrap text-left italic font-semibold text-md'>
              We roll as five, but we move as one. Three Chartered Accountants who balance numbers with precision,<br />
              one Cost Management Accountant who finds value in every detail, and one techie who codes solutions into reality.
            </p>
            <p className='text-wrap text-left italic font-semibold text-md'>
              As working professionals, we hustle through deadlines, audits, and projects, <br />
              yet never lose the laughter, the tea breaks, or the late‑night talks that keep us grounded.
            </p>
            <p className='text-wrap text-left italic font-semibold text-md '>
              Together we are more than colleagues; we are homies, a squad of growth, hustle, and friendship.<br />
      ...
      <Box className='w-full p-5 justify-center items-center' sx={{display:{xl:"none", lg:"none", md:"block", sm:"block", xs:"block"}}}>
        <p className='text-wrap text-center italic font-semibold text-sm'>My dear honourable 🐛🔥's if you have any suggestion,kindly ping me don't bite my d!ck</p>
      </Box>
    </div>
  )
}
